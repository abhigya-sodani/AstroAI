...
try:
    ...
    for i in range(0,160):
        for j in range(0,320):
            a=extract_features("https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/MODIS_Terra_CorrectedReflectance_TrueColor/default/2005-08-29/250m/8/"+str(i)+"/"+str(j)+".jpg", model1)
            print("length",len(a))
            features.append(a)
            print(str(i)+" "+str(j))
